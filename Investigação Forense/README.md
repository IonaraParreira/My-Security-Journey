...
<h1>🕵️‍♂️ Passo 1: O Armazenamento (A Coleta das Evidências)</h1>
...
<h1>🗄️ Passo 2: A Retenção (A Linha do Tempo no Laboratório)</h1>
...
<h1>✂️ Passo 3: A Exclusão (Limpando os Rastros após o Caso Fechado)</h1>
...
Armazenamento (Coleta/Preservação): Quando eu isolei a máquina, usei o bloqueador de escrita para copiar o log sem alterar os metadados e travei tudo com o Hash SHA-256 (a impressão digital do arquivo).

Retenção (Guarda/Histórico): Quando eu fui buscar os logs antigos compactados (.tar.gz) que a empresa guardou por 90 dias para conseguir cruzar os dados e achar o IP do hacker semanas atrás.
